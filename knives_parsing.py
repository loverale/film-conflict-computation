...
def knives_character_name_parser():
    with open(knives_extracted, "r") as file:
        text_data = file.read()
    # print(text_data)
    ...
    with open(knives_extracted_cleaned, "w") as file:
        file.write(text_data)

# todo:// better function name
def knives_text_to_json():
    ...
    with open(knives_extracted_cleaned, "r") as file:
    ...
    with open(knives_json, 'w') as json_file:
